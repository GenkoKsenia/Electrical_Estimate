...
public class Calculator extends Dialog {
    ...
    private static EditText areaValue; // площадь
    private static EditText socketsValue; // розетки
    private static EditText switchesValue; // выключатели

    private Spinner materialValue; // материал

    private static ListWorks works;

    private static String choiceMaterial;
    ...
    public static ListWorks calculationVolume(){
